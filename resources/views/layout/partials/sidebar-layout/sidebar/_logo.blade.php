...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <a href="{{ route('dashboard') }}" class="d-flex align-items-center text-decoration-none">
        <img alt="Logo" src="{{ asset('icon/icon.png') }}" class="h-35px app-sidebar-logo-default me-2" />
        <span class="fw-bold text-gray-800 fs-6 app-sidebar-logo-default">Dinas Pendapatan Daerah Tabalong</span>
        <img alt="Logo" src="{{ asset('icon/icon.png') }}" class="h-25px app-sidebar-logo-minimize" />
    </a>
    <!--end::Logo image-->
